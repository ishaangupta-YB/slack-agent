...
<tool_call>
{"tool": "plausible_query", "params": {"site_id": "huggingface.co", "metrics": ["visitors", "pageviews"], "dimensions": ["event:page"], "date_range": "7d", "limit": 10}}
</tool_call>

Traffic sources this month:

<tool_call>
{"tool": "plausible_query", "params": {"site_id": "huggingface.co", "metrics": ["visitors"], "dimensions": ["visit:source"], "date_range": "30d", "limit": 10}}
</tool_call>

Visits to a specific page over time:

<tool_call>
{"tool": "plausible_query", "params": {"site_id": "huggingface.co", "metrics": ["visitors", "pageviews"], "dimensions": ["event:page"], "date_range": "30d", "filters": ["event:page==/docs"], "limit": 10}}
</tool_call>
